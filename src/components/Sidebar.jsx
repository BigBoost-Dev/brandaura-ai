...
export default function Sidebar({ activeTab, onTabChange, resultsCount = 0, isOpen, onClose }) {
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className={`
        fixed left-0 top-[65px] bottom-0 w-60 p-4 border-r border-white/5 bg-dark-400 z-50
      ...
      `}>
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <div className="p-4 rounded-xl bg-gradient-to-br from-primary-500/10 to-purple-500/5 border border-primary-500/20">
            ...
            <a href="#" className="text-xs text-primary-400 hover:text-primary-300 font-medium">View Docs →</a>
          </div>
        </div>
      </aside>
    </>
